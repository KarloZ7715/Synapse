...
│
├── final/                        # Dataset final para entrenamiento (Fase 4, pendiente)
...
│   └── backup/                   # Scripts operativos de respaldo (fase 3)
│
...
| Día | Tarea | Script |
|-----|-------|--------|
| 1 | Descargar GoEmotions ES + mapear emociones | `download_goemotions.py`, `map_emotions.py` |
| 1-2 | Extraer preguntas SO ES | `extract_so.py` |
| 2 | Etiquetar con Copilot | `label_with_copilot.py` |
| 3 | Data augmentation + validación | *(pendiente Fase 4)* |
